...
run(`cd ${LANG_ROOT} && npx tsp compile ${CACHE}/alltypes.tsp --emit=@specodec/typespec-emitter-typescript \
  --option @specodec/typespec-emitter-typescript.emitter-output-dir=${emitGen}`);
